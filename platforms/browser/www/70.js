...
var Searchbar = /** @class */ (function () {
    function Searchbar(hostRef) {
        ...
        this.ionInput = Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionInput", 7);
        ...
        this.ionClear = Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, "ionClear", 7);
    ...
    Searchbar.prototype.__stencil_render = function () {
        ...
        var cancelButton = !isCancelButtonSetToNever(this.showCancelButton) && (Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", { type: "button", tabIndex: mode === 'ios' && !this.shouldShowCancelButton() ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" }, Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", null, mode === 'md'
            ? Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { mode: mode, icon: this.cancelButtonIcon, lazy: false })
            : this.cancelButtonText)));
        return [
            Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "searchbar-input-container" }, Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("input", { disabled: this.disabled, ref: function (el) { return _this.nativeInput = el; }, class: "searchbar-input", onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, placeholder: this.placeholder, type: this.type, value: this.getValue(), autoComplete: this.autocomplete, autoCorrect: this.autocorrect, spellCheck: this.spellcheck }), mode === 'md' && cancelButton, Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { mode: mode, icon: searchIcon, lazy: false, class: "searchbar-search-icon" }), Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", { type: "button", "no-blur": true, class: "searchbar-clear-button", onMouseDown: this.onClearInput, onTouchStart: this.onClearInput }, Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { mode: mode, icon: clearIcon, lazy: false, class: "searchbar-clear-icon" }))),
    ...
    Searchbar.prototype.render = function () { return Object(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_chunk_83ae3fca_js__WEBPACK_IMPORTED_MODULE_1__["H"], this.hostData(), this.__stencil_render()); };
