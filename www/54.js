...
/* harmony import */ var _chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-0b9585cb.js */ "./node_modules/@ionic/core/dist/esm/legacy/chunk-0b9585cb.js");
...
var Nav = /** @class */ (function () {
    ...
    Nav.prototype.componentDidUnload = function () {
        for (var _i = 0, _a = this.views; _i < _a.length; _i++) {
            var view = _a[_i];
            Object(_chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__["l"])(view.element, _chunk_94c4865f_js__WEBPACK_IMPORTED_MODULE_3__["d"]);
            view._destroy();
        }
        if (this.gesture) {
    ...
    Nav.prototype.postViewInit = function (enteringView, leavingView, ti) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (var _a = 0, destroyQueue_1 = destroyQueue; _a < destroyQueue_1.length; _a++) {
                ...
                Object(_chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__["l"])(view.element, _chunk_94c4865f_js__WEBPACK_IMPORTED_MODULE_3__["b"]);
                Object(_chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__["l"])(view.element, _chunk_94c4865f_js__WEBPACK_IMPORTED_MODULE_3__["c"]);
                Object(_chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__["l"])(view.element, _chunk_94c4865f_js__WEBPACK_IMPORTED_MODULE_3__["d"]);
            }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(_chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__["t"])(animationOpts)];
                    case 1:
    ...
    Nav.prototype.cleanup = function (activeView) {
        ...
        for (var i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                Object(_chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__["l"])(element, _chunk_94c4865f_js__WEBPACK_IMPORTED_MODULE_3__["d"]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                // this view comes before the active view
                // and it is not a portal then ensure it is hidden
                Object(_chunk_0b9585cb_js__WEBPACK_IMPORTED_MODULE_6__["s"])(element, true);
            }
        }
    };
